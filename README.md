...
Version 0.1.8/build 10 is the latest [published stable release](https://github.com/mneves75/open-profile-manager/releases/tag/v0.1.8), following the verified `v0.1.8-beta1` prerelease. Both releases are immutable, Developer ID-signed, notarized, and stapled. Version 0.1.9 is the next unreleased target. See [PROJECT_STATUS.md](PROJECT_STATUS.md), [CHANGELOG.md](CHANGELOG.md), and the [release procedure](docs/RELEASING.md).
