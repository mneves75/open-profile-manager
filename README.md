...
Version 0.1.4 is the current unreleased source line. Version 0.1.3 remains the latest [published GitHub Release](https://github.com/mneves75/open-profile-manager/releases/tag/v0.1.3). See [PROJECT_STATUS.md](PROJECT_STATUS.md) and [CHANGELOG.md](CHANGELOG.md).
