...
9. **Logging and errors:** the project does not dump environments, raw authentication files, child stderr, or raw app-server payloads. User errors are bounded summaries.
